...
<body class="bg-primary-subtle">
  ...
  <div class="card mt-4 mx-5">
   ...
   <fieldset>
       <legend border-b-2 w-full mb-2 border-gray-300">
           Name of church/member body with whom the candidate is siging the service argreement with
       </legend>
   </fieldset>
   <div class="row">
       <div class="col-12">
       ...
       <option value="CHRISTIAN MEDICAL COLLEGE, LUDHIANA (ONLY FOR 2G)">CHRISTIAN MEDICAL COLLEGE, LUDHIANA (ONLY FOR 2G)</option></select>
       </div>
   </div>
   <div class="row">
